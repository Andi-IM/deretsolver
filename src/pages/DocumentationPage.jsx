            ...
            <div className="grid gap-12">
                ...
                <section className="space-y-4">
                    ...
                    <div className="prose prose-slate max-w-none text-slate-600">
                        <p>
                            Enter a sequence of numbers separated by commas or spaces (e.g., <code className="bg-slate-100 px-1.5 py-0.5 rounded text-slate-800 font-mono text-sm">2, 4, 6, 8</code>). 
                 ...
                 <section className="space-y-4">
                    ...
                    <div className="bg-amber-50 border border-amber-100 rounded-xl p-6">
                        <div className="flex items-start gap-4">
                            <span className="material-symbols-outlined text-amber-600 text-3xl shrink-0">vpn_key</span>
                            <div className="space-y-3">
                                <h4 className="font-bold text-amber-900 text-base">Gemini API Key Required for Advanced Solving</h4>
                                <p className="text-amber-800 text-sm leading-relaxed">
                                    While basic patterns (Arithmetic, Geometric) work offline, <strong>Complex, Interleaved, or Abstract patterns</strong> require Google's Gemini AI.
                                </p>
                                <div className="pt-2">
                                     <a 
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {[
                            { name: 'Arithmetic Progression', desc: 'Adds/subtracts a constant value', ex: '2, 5, 8, 11' },
                            { name: 'Geometric Progression', desc: 'Multiplies/divides by a constant', ex: '3, 6, 12, 24' },
                            { name: 'Fibonacci Sequence', desc: 'Sum of previous two numbers', ex: '1, 1, 2, 3, 5' },
                            { name: 'Triangular Numbers', desc: 'Adds increasing integers', ex: '1, 3, 6, 10, 15' },
                            { name: 'Interleaved Sequences', desc: 'Two patterns alternating', ex: '1, 10, 2, 20, 3' },
                            { name: 'Perfect Squares/Cubes', desc: 'Powers of integers', ex: '1, 4, 9, 16' },
                            { name: 'Two-Level Difference', desc: 'Constant change in differences', ex: '1, 3, 6, 10' },
                        ].map((item, i) => (
                            <div key={i} className="flex items-start gap-3 p-4 bg-white border border-slate-100 rounded-xl shadow-sm hover:border-blue-200 transition-colors">
                                ...
                                <div>
                                    ...
                                    <code className="font-mono text-[10px] bg-slate-50 px-2 py-1 rounded border border-slate-200 text-slate-600 block w-fit">{item.ex}</code>
                                </div>
                            </div>
                        ))}
                    </div>
