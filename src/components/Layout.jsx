          ...
          <Link to="/" className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center text-white shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75H21a.75.75 0 01.75.75v5.25a.75.75 0 01-.75.75h-5.25a.75.75 0 01-.75-.75V16.5a.75.75 0 01.75-.75z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h5.25a.75.75 0 01.75.75v5.25a.75.75 0 01-.75.75H3a.75.75 0 01-.75-.75V3.75A.75.75 0 013 3zM3 15.75h5.25a.75.75 0 01.75.75v5.25a.75.75 0 01-.75.75H3a.75.75 0 01-.75-.75V16.5a.75.75 0 01.75-.75z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 4.5h.008v.008h-.008V4.5zM16.5 8.25h.008v.008h-.008V8.25zM19.5 4.5h.008v.008h-.008V4.5zM19.5 8.25h.008v.008h-.008V8.25z" />
                </svg>
            </div>
